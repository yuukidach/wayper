...
(function () {
    ...
    const ZH = {
        ...
        'Launch Wayper in the system tray with your desktop session': '进入桌面时在系统托盘中启动 Wayper',
        ...
        'Enter at least two different tags': '请输入至少两个不同的标签',
        'This combination already exists': '该组合规则已存在',
        ...
        'Auto-held': '已自动拦截',
        Recommended: '建议检查',
        'Clear auto-held': '清空已拦截',
        'Clearing…': '正在清空…',
        'Filter all auto-held wallpapers without teaching the model': '过滤全部自动拦截图片，但不作为偏好反馈',
        'Clear all automatically held wallpapers': '清空所有自动拦截的图片',
        'Some held wallpapers could not be cleared. The remaining cards are unchanged.': '部分自动拦截图片无法清空；剩余卡片未改变。',
        'Could not clear the held queue: {error}': '无法清空自动拦截队列：{error}',
        Counter: '保留依据',
